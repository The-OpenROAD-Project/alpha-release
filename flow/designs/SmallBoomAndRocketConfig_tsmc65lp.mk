export DESIGN_NAME = SmallBoomAndRocketConfig
export PLATFORM    = tsmc65lp

export VERILOG_FILES = $(wildcard ./designs/src/SmallBoomAndRocketConfig/*.v)
export SDC_FILE      = ./designs/src/SmallBoomAndRocketConfig/SmallBoomAndRocketConfig.sdc
