export DESIGN_NAME = DualLargeBoomAndDualRocketConfig
export PLATFORM    = tsmc65lp

export VERILOG_FILES = $(wildcard ./designs/src/DualLargeBoomAndDualRocketConfig/*.v)
export SDC_FILE      = ./designs/src/DualLargeBoomAndDualRocketConfig/DualLargeBoomAndDualRocketConfig.sdc
