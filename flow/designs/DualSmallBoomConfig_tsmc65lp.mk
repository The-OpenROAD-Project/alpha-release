export DESIGN_NAME = DualSmallBoomConfig
export PLATFORM    = tsmc65lp

export VERILOG_FILES = $(wildcard ./designs/src/DualSmallBoomConfig/*.v)
export SDC_FILE      = ./designs/src/DualSmallBoomConfig/DualSmallBoomConfig.sdc
