export DESIGN_NAME = MegaBoomConfig
export PLATFORM    = tsmc65lp

export VERILOG_FILES = $(wildcard ./designs/src/MegaBoomConfig/*.v)
export SDC_FILE      = ./designs/src/MegaBoomConfig/MegaBoomConfig.sdc
